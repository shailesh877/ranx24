            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12">
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-5xl font-black text-gray-900 mb-4 tracking-tight">
                        Create Your <span className="text-indigo-600">Custom AMC Package</span>
                    </h1>
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto font-medium">
                        Select multiple services to create a custom AMC package tailored for your home.
                    </p>
                </div>
                ...
                <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-lg group hover:border-indigo-200 transition-colors">
                        ...
                        <p className="text-gray-500 font-medium text-sm leading-relaxed">Certified technicians ensuring your home installations and repairs are done perfectly.</p>
                    </div>
                    <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-lg group hover:border-indigo-200 transition-colors">
                    ...
                    <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-lg group hover:border-indigo-200 transition-colors">
                        ...
                        <h3 className="text-xl font-black text-gray-900 mb-3">Custom Plans</h3>
                        <p className="text-gray-500 font-medium text-sm leading-relaxed">Choose exactly what you need. Combine electrical, plumbing, cleaning and other plans into one.</p>
                    </div>
                </div>
            </div>
        </div>

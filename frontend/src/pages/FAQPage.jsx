...
import { LucideHelpCircle, LucideChevronDown, LucideChevronUp } from 'lucide-react';
            ...
            <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm p-8 sm:p-12">
                <div className="flex items-center justify-center mb-8">
                    <div className="bg-blue-100 p-4 rounded-full">
                        <LucideHelpCircle size={40} className="text-blue-600" />
                    </div>
                </div>

                <h1 className="text-3xl font-bold text-center text-gray-900 mb-2">Frequently Asked Questions</h1>
                <p className="text-center text-gray-500 mb-10">Common questions about RanX24 Home Service</p>

                <div className="space-y-8">
                    {faqs.map((section, sectionIndex) => (
                        <div key={sectionIndex} className="bg-gray-50 rounded-xl p-6 border border-gray-100">
                                    ...
                                    return (
                                        <div key={itemIndex} className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                                            ...
                                            >
                                                ...
                                                {isOpen ? <LucideChevronUp size={20} className="text-blue-600 flex-shrink-0" /> : <LucideChevronDown size={20} className="text-gray-400 flex-shrink-0" />}
                                            </button>
                                            {isOpen && (

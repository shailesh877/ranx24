...
export const updateFees = async (req, res) => {
    try {
        const { platformFee, percentageCharge, workerRegistrationFee, isActive } = req.body;
        ...
        if (workerRegistrationFee !== undefined) config.workerRegistrationFee = workerRegistrationFee;
